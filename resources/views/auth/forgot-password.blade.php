            ...
            <div class="authentication-inner py-4">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mb-4">Masukan email anda dan kami akan mengirimkan instruksi untuk reset password</p>
                        ...
                        <form id="formAuthentication" class="mb-3" action="{{ route('password.email') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <x-text-input id="email" class="form-control" type="email" name="email" :value="old('email')" placeholder="Masukan Email Anda" required autofocus />
